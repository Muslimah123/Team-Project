...
<body >
    <div style="font-size: 40px; margin-left:500px; margin-bottom:100px;"> Add Category
        ...
        <div style=" margin-left:500px; margin-right:500px;">
            <form method="POST" action="../actions/add_category.php" onsubmit="required()" name="form1">
                            ...
                            echo " 
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='../actions/add_category.php?delete=$categoryID' class='btn btn-dark'>Delete</a>
                                    </td>
                                </tr>";
                        }
                    }
