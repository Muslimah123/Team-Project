...
<head>
    ...
    <title>B3rnice | Product</title>
</head>
<body>
    <?php
        include("../actions/showAlerts.php");
        showUpdateAlert();
    ?>
    ...
    <div class="form-popup" id="myForm">
        <form method="POST" action="../actions/add_product.php" class="form-container" onsubmit="required()" name="form1" enctype="multipart/form-data">
            ...
            <select name="category" class="form-control" id="text">
                <option value="Select category:" required>Select category:</option>
                <?php
            ...
            <select name="brand" class="form-control"  required  id="text">
                            ...
                            echo " 
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='../actions/add_product.php?delete=$productID' class='btn btn-dark'>Delete</a>
                                    </td>
                                </tr>";
                        }
                    }
